...
{
	public static Block bronze_block, steel_block, titanium_block, adamantium_block, tungsten_block, mithril_block, orichalcum_block,
						fusion_furnace;
	
	public static Block[] listBlock = new Block[8];
	public static Item[] listBlockItem = new Item[8];
	...
	public static void initlaization()
	{
		...
		orichalcum_block = register("orichalcum_block", new Block(Material.IRON)).setCreativeTab(CreativeTabs.BUILDING_BLOCKS);
