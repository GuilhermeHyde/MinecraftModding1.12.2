...
public class EntityLevelProvider implements ICapabilitySerializable<NBTTagCompound>
{
	@CapabilityInject(EntityLevel.class)
	public static final Capability<EntityLevel> ENTITY_LEVEL_CAP = null;
	private EntityLevel instance = new EntityLevel();
